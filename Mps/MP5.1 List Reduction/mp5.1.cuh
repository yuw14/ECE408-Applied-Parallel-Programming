...
int main(int argc, char **argv) {
  ...
  int deviceInputSize=numInputElements*sizeof(float);
  cudaMalloc((void**)&deviceInput,deviceInputSize);
  int deviceOutputSize=numOutputElements*sizeof(float);
  ...
  //dim3 dimGrid(ceil(ceil(numInputElements/2)/BLOCK_SIZE),1,1);
